<section class="featured-product-box full-width-products padding-45">
    <div class="container">
        <!-- product hadding -->
        <div class="product-hadding text-center">
            <h2 class="no-margin">Sản phẩm nổi bậc</h2>
            <p class="no-margin">Những sản phẩm nổi bậc được đánh giá cao.</p>
        </div>
        <?php if ($products->count() > 0): ?>
            <div class="featured-product product-container product-column-2 padding-40">
