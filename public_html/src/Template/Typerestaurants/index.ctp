...
/**
  ...
  * @var \App\Model\Entity\Typerestaurant[]|\Cake\Collection\CollectionInterface $typerestaurants
  */
?>
...
<div class="typerestaurants index large-9 medium-8 columns content">
    <h3><?= __('Typerestaurants') ?></h3>
