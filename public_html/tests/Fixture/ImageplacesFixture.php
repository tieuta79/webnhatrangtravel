 ...
 *
 */
class ImageplacesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'FK_images_places' => ['type' => 'index', 'columns' => ['place_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_images_places' => ['type' => 'foreign', 'columns' => ['place_id'], 'references' => ['vehicles', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'featured' => 1,
            'created' => '2018-06-01 03:23:37',
            'modified' => '2018-06-01 03:23:37'
        ],
    ];
}
