 ...
 *
 */
class BlackusersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'FK_users_blackusers' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_users_blackusers' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2018-06-01 03:22:02',
            'modified' => '2018-06-01 03:22:02'
        ],
    ];
}
