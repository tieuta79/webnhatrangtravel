 ...
 *
 */
class RateplacesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'FK_rateplaces_users' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
            'FK_rateplaces_places' => ['type' => 'index', 'columns' => ['place_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_rateplaces_places' => ['type' => 'foreign', 'columns' => ['place_id'], 'references' => ['places', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'FK_rateplaces_users' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'featured' => 1,
            'created' => '2018-06-11 06:33:43',
            'modified' => '2018-06-11 06:33:43'
        ],
    ];
}
