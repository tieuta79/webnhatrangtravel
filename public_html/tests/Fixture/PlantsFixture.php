...
class PlantsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'descripton' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'featured' => 1,
            'created' => '2018-06-22 08:22:23',
            'modified' => '2018-06-22 08:22:23',
            'view' => 1
        ],
    ];
}
