...
class FoodsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'typefood_id' => ['type' => 'integer', 'length' => 20, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'FK_foods_restaurants' => ['type' => 'index', 'columns' => ['restaurant_id'], 'length' => []],
            'FK_foods_typefoods' => ['type' => 'index', 'columns' => ['typefood_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_foods_restaurants' => ['type' => 'foreign', 'columns' => ['restaurant_id'], 'references' => ['restaurants', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'FK_foods_typefoods' => ['type' => 'foreign', 'columns' => ['typefood_id'], 'references' => ['typefoods', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'featured' => 1,
            'created' => '2018-06-01 03:23:19',
            'modified' => '2018-06-01 03:23:19'
        ],
    ];
}
