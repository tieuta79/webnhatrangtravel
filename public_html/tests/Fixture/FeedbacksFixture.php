...
class FeedbacksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'FK_feedbacks_users' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_feedbacks_users' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'featured' => 1,
            'created' => '2018-06-01 03:23:08',
            'modified' => '2018-06-01 03:23:08'
        ],
    ];
}
