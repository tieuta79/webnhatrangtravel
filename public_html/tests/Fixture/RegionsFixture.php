...
class RegionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'FK_regions_provinces' => ['type' => 'index', 'columns' => ['province_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_regions_provinces' => ['type' => 'foreign', 'columns' => ['province_id'], 'references' => ['provinces', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2018-06-01 03:24:05',
            'modified' => '2018-06-01 03:24:05'
        ],
    ];
}
