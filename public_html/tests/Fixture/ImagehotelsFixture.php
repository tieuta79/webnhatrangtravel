 ...
 *
 */
class ImagehotelsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'FK_images_hotels' => ['type' => 'index', 'columns' => ['hotel_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_images_hotels' => ['type' => 'foreign', 'columns' => ['hotel_id'], 'references' => ['hotels', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'featured' => 1,
            'created' => '2018-06-01 03:23:31',
            'modified' => '2018-06-01 03:23:31'
        ],
    ];
}
