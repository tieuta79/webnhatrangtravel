 ...
 *
 */
class RatehotelsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'FK_ratehotels_users' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
            'FK_ratehotels_hotels' => ['type' => 'index', 'columns' => ['hotel_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_ratehotels_hotels' => ['type' => 'foreign', 'columns' => ['hotel_id'], 'references' => ['hotels', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'FK_ratehotels_users' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'featured' => 1,
            'created' => '2018-06-11 06:33:39',
            'modified' => '2018-06-11 06:33:39'
        ],
    ];
}
