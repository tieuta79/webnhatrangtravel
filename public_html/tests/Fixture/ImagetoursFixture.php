 ...
 *
 */
class ImagetoursFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'FK_images_tours' => ['type' => 'index', 'columns' => ['tour_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_images_tours' => ['type' => 'foreign', 'columns' => ['tour_id'], 'references' => ['tours', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'featured' => 1,
            'created' => '2018-06-01 03:23:48',
            'modified' => '2018-06-01 03:23:48'
        ],
    ];
}
