...
class ToursFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'region_id' => ['type' => 'integer', 'length' => 20, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'FK_tours_users' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
            'FK_tours_regions' => ['type' => 'index', 'columns' => ['region_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_tours_regions' => ['type' => 'foreign', 'columns' => ['region_id'], 'references' => ['regions', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'FK_tours_users' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'start' => '2018-06-01 03:24:19',
            'end' => '2018-06-01 03:24:19',
            'view' => 1,
            'status' => 1,
            'featured' => 1,
            'created' => '2018-06-01 03:24:19',
            'modified' => '2018-06-01 03:24:19'
        ],
    ];
}
